package com.bakhur.translator.android.voice_to_text
...
class AndroidVoiceToTextParser(
    ...
    private val recogniser = SpeechRecognizer.createSpeechRecognizer(context)

    private val _state = MutableStateFlow(VoiceToTextParserState())
    override val state: CommonStateFlow<VoiceToTextParserState>
        get() = _state.toCommonMutableStateFlow()
    ...
    override fun startListening(languageCode: String) {
        ...
        with(recogniser) {
            setRecognitionListener(this@AndroidVoiceToTextParser)
    ...
    override fun cancel() = recogniser.cancel()
